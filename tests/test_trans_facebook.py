...
class TestFacebook(unittest.TestCase):
    ...
    def test_process_urls(self):
        available_urls = [ { 'url': 'https://transparency.facebook.com/download/2013-H1/', 'start_date': '2013-01-01 00:00:00', 'end_date': '2013-06-30 23:59:59'} ]
    ...
    def test_process_urls_unreachable(self):
        ...
        available_urls = [ { 'url': unavailableURL, 'start_date': '2013-01-01 00:00:00', 'end_date': '2013-06-30 23:59:59'} ]
